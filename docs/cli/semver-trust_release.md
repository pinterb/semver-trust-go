...
```
      ...
      --bootstrap-descriptor string   out-of-band v0.10 bootstrap descriptor (§5.4/§7.5, ADR-028/029); when supplied, the version line is derived from the authenticated descriptor rather than --from. Must be supplied from outside the repository
